...
EOT;
    ...
    public function render()
    {
        ...
        $loginCheckPath = $this->generateUrl('user_login_check');

        $loginGoogle   = $this->generateUrl('user_authen_connect',['providerName' => 'google']);
        $loginFacebook = $this->generateUrl('user_authen_connect',['providerName' => 'facebook']);
