...
namespace AppBundle\Action\Services;
...
class VolCerts
{
    ...
    {
        $this->urlVolCerts = "https://national.ayso.org/Volunteers/ViewCertification?UserName=";
...
//
    ...
    public function ViewCertificationLink($id)
    {
        if (empty($id)) {
            return null;
        }

        return $this->urlVolCerts . $id;
    }
