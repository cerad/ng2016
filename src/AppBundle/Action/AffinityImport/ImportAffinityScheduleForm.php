...
class ImportAffinityScheduleForm extends AbstractForm
{
...
<form role="form" style="width: 1200px;" action="{$action}" method="post" enctype="multipart/form-data">
  ...
  <a href="{$this->generateUrl('game_listing')}" class="btn bth-sm btn-default" ><span class="glyphicon glyphicon-chevron-left"></span>Back To Game Listing</a>
</form>
<br/>
EOD;
        return $html;
