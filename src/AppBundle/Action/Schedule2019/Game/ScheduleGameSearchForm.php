...
<form role="form" class="form-inline" action="{$action}" method="post">
  ...
  <div class="schedule-search col-xs-8 col-xs-offset-2 clearfix">
    ...
    <a href="{$this->generateUrl('schedule_game_2016',['_format' => 'txt'])}" class="btn btn-sm btn-primary pull-right"><span class="glyphicon glyphicon-share"></span> Export to Text</a>
