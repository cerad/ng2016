...
<form role="form" class="form-inline" action="{$action}" method="post">
  ...
  <div class="schedule-search col-xs-8 col-xs-offset-2 clearfix">
    ...
    <a href="{$this->generateUrl('schedule_game_2017',['_format' => 'txt'])}" download class="btn btn-sm btn-primary pull-right"><span class="glyphicon glyphicon-share"></span> Export to Text</a>
    <a href="{$this->generateUrl('schedule_game_2017',['_format' => 'xls'])}" download class="btn btn-sm btn-primary pull-right"><span class="glyphicon glyphicon-share"></span> Export to Excel</a>
