...
class InitGames2017Command extends Command
{
    private $gameConn;
    private $regTeamConn;
    ...
    {
        $this
            ->setName('init:games:aoc2017')
            ->setDescription('Init Games AOC2016');
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        echo sprintf("Init Games AOC2016 ...\n");
        ...
        echo sprintf("Init Games AOC2017 Completed.\n");
    }
        ...
        foreach ($this->programs as $program) {
            foreach ($this->ages as $age) {
                foreach ($this->genders as $gender) {
                    ...
                    $medalRoundPools = [
                        'SF' => [
                            '1' => [['game' =>  5, 'name' => 'X', 'slot' => 'A 1st'], ['game' =>  5, 'name' => 'Y', 'slot' => 'B 2nd']],
                            '2' => [['game' =>  6, 'name' => 'X', 'slot' => 'B 1st'], ['game' =>  6, 'name' => 'Y', 'slot' => 'A 2nd']],
                        ],
                        'TF' => [
                            '1' => [['game' =>  7, 'name' => 'X', 'slot' => 'A 1st'], ['game' =>  7, 'name' => 'Y', 'slot' => 'A 2nd']],
                        ],
                    ];
    ...
    private function initGames($commit)
    {
        ...
        $fieldSlots = [
            ...
            [1, 'Thu', '07:30', 'A1', 'A2', 'G'], [2, 'Thu', '07:30', 'A3', 'A5', 'G'], [3, 'Thu', '07:30', 'A4', 'A6', 'G'],
            [4, 'Thu', '07:30', 'C1', 'C2', 'G'], [5, 'Thu', '07:30', 'C3', 'C5', 'G'], [6, 'Thu', '07:30', 'C4', 'C6', 'G'],
            [1, 'Thu', '08:45', 'D1', 'D2', 'G'], [2, 'Thu', '08:45', 'D3', 'D5', 'G'], [3, 'Thu', '08:45', 'D4', 'D6', 'G'],
            [4, 'Thu', '08:45', 'B1', 'B2', 'G'], [5, 'Thu', '08:45', 'B3', 'B5', 'G'], [6, 'Thu', '08:45', 'B4', 'B6', 'G'],

            [1, 'Thu', '10:45', 'A2', 'A4', 'G'], [2, 'Thu', '10:45', 'A3', 'A1', 'G'], [3, 'Thu', '10:45', 'A6', 'A5', 'G'],
            [4, 'Thu', '10:45', 'C2', 'C4', 'G'], [5, 'Thu', '10:45', 'C3', 'C1', 'G'], [6, 'Thu', '10:45', 'C6', 'C5', 'G'],
            [1, 'Thu', '12:00', 'D2', 'D4', 'G'], [2, 'Thu', '12:00', 'D3', 'D1', 'G'], [3, 'Thu', '12:00', 'D6', 'D5', 'G'],
            [4, 'Thu', '12:00', 'B2', 'B4', 'G'], [5, 'Thu', '12:00', 'B3', 'B1', 'G'], [6, 'Thu', '12:00', 'B6', 'B5', 'G'],

            [1, 'Thu', '13:15', 'A1', 'A2', 'B'], [2, 'Thu', '13:15', 'A3', 'A5', 'B'], [3, 'Thu', '13:15', 'A4', 'A6', 'B'],
            [4, 'Thu', '13:15', 'C1', 'C2', 'B'], [5, 'Thu', '13:15', 'C3', 'C5', 'B'], [6, 'Thu', '13:15', 'C4', 'C6', 'B'],
            [1, 'Thu', '14:30', 'D1', 'D2', 'B'], [2, 'Thu', '14:30', 'D3', 'D5', 'B'], [3, 'Thu', '14:30', 'D4', 'D6', 'B'],
            [4, 'Thu', '14:30', 'B1', 'B2', 'B'], [5, 'Thu', '14:30', 'B3', 'B5', 'B'], [6, 'Thu', '14:30', 'B4', 'B6', 'B'],

            [1, 'Thu', '16:30', 'A2', 'A4', 'B'], [2, 'Thu', '16:30', 'A3', 'A1', 'B'], [3, 'Thu', '16:30', 'A6', 'A5', 'B'],
            [4, 'Thu', '16:30', 'C2', 'C4', 'B'], [5, 'Thu', '16:30', 'C3', 'C1', 'B'], [6, 'Thu', '16:30', 'C6', 'C5', 'B'],
            [1, 'Thu', '17:45', 'D2', 'D4', 'B'], [2, 'Thu', '17:45', 'D3', 'D1', 'B'], [3, 'Thu', '17:45', 'D6', 'D5', 'B'],
            [4, 'Thu', '17:45', 'B2', 'B4', 'B'], [5, 'Thu', '17:45', 'B3', 'B1', 'B'], [6, 'Thu', '17:45', 'B6', 'B5', 'B'],

            [1, 'Fri', '07:30', 'A5', 'A2', 'B'], [2, 'Fri', '07:30', 'A1', 'A4', 'B'], [3, 'Fri', '07:30', 'A6', 'A3', 'B'],
            [4, 'Fri', '07:30', 'C5', 'C2', 'B'], [5, 'Fri', '07:30', 'C1', 'C4', 'B'], [6, 'Fri', '07:30', 'C6', 'C3', 'B'],
            [1, 'Fri', '08:45', 'D5', 'D2', 'B'], [2, 'Fri', '08:45', 'D1', 'D4', 'B'], [3, 'Fri', '08:45', 'D6', 'D3', 'B'],
            [4, 'Fri', '08:45', 'B5', 'B2', 'B'], [5, 'Fri', '08:45', 'B1', 'B4', 'B'], [6, 'Fri', '08:45', 'B6', 'B3', 'B'],

            [1, 'Fri', '10:45', 'A2', 'A6', 'B'], [2, 'Fri', '10:45', 'A5', 'A1', 'B'], [3, 'Fri', '10:45', 'A4', 'A3', 'B'],
            [4, 'Fri', '10:45', 'C2', 'C6', 'B'], [5, 'Fri', '10:45', 'C5', 'C1', 'B'], [6, 'Fri', '10:45', 'C4', 'C3', 'B'],
            [1, 'Fri', '12:00', 'D2', 'D6', 'B'], [2, 'Fri', '12:00', 'D5', 'D1', 'B'], [3, 'Fri', '12:00', 'D4', 'D3', 'B'],
            [4, 'Fri', '12:00', 'B2', 'B6', 'B'], [5, 'Fri', '12:00', 'B5', 'B1', 'B'], [6, 'Fri', '12:00', 'B4', 'B3', 'B'],

            [1, 'Fri', '13:15', 'A5', 'A2', 'G'], [2, 'Fri', '13:15', 'A1', 'A4', 'G'], [3, 'Fri', '13:15', 'A6', 'A3', 'G'],
            [4, 'Fri', '13:15', 'C5', 'C2', 'G'], [5, 'Fri', '13:15', 'C1', 'C4', 'G'], [6, 'Fri', '13:15', 'C6', 'C3', 'G'],
            [1, 'Fri', '14:30', 'D5', 'D2', 'G'], [2, 'Fri', '14:30', 'D1', 'D4', 'G'], [3, 'Fri', '14:30', 'D6', 'D3', 'G'],
            [4, 'Fri', '14:30', 'B5', 'B2', 'G'], [5, 'Fri', '14:30', 'B1', 'B4', 'G'], [6, 'Fri', '14:30', 'B6', 'B3', 'G'],

            [1, 'Fri', '16:30', 'A2', 'A6', 'G'], [2, 'Fri', '16:30', 'A5', 'A1', 'G'], [3, 'Fri', '16:30', 'A4', 'A3', 'G'],
            [4, 'Fri', '16:30', 'C2', 'C6', 'G'], [5, 'Fri', '16:30', 'C5', 'C1', 'G'], [6, 'Fri', '16:30', 'C4', 'C3', 'G'],
            [1, 'Fri', '17:45', 'D2', 'D6', 'G'], [2, 'Fri', '17:45', 'D5', 'D1', 'G'], [3, 'Fri', '17:45', 'D4', 'D3', 'G'],
            [4, 'Fri', '17:45', 'B2', 'B6', 'G'], [5, 'Fri', '17:45', 'B5', 'B1', 'G'], [6, 'Fri', '17:45', 'B4', 'B3', 'G'],
